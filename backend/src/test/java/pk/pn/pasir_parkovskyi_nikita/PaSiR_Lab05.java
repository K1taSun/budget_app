...
/**
 * PaSiR_Lab05 – testy automatyczne dla funkcjonalności grup, długów i członkostw.
...
class PaSiR_Lab05 {
    ...
    void createGroup_addsOwnerAsMemberAndAppearsInMyGroups() {
        loginAs(owner);
    ...
    void addMember_onlyOwnerCanAdd() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Wakacje");
        Group group = groupService.createGroup(dto);
    ...
    void groupMembers_onlyVisibleToMember() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Sklep");
        Group group = groupService.createGroup(dto);
    ...
    void groupDebts_onlyVisibleToMember() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Podróż");
        Group group = groupService.createGroup(dto);
    ...
    void newMember_seesOnlyDebtsAfterJoining() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Dom");
        Group group = groupService.createGroup(dto);
    ...
    void groupTransaction_income_currentUserIsDebtor() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Praca");
        Group group = groupService.createGroup(dto);
    ...
    void removeMember_doesNotDeleteHistoricalDebts() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void deleteGroup_onlyOwnerCanDelete() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void createDebt_onlyBetweenGroupMembers() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void createDebt_rejectsOutsiderAndSelfDebt() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void createDebt_ownerCanCreateBetweenOtherMembers() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Projekt");
        Group group = groupService.createGroup(dto);
    ...
    void createDebt_memberCanCreateOnlyAsParticipant() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Sport");
        Group group = groupService.createGroup(dto);
    ...
    void deleteDebt_participantCanDelete() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void deleteDebt_nonParticipantNonOwnerCannotDelete() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Ochrona");
        Group group = groupService.createGroup(dto);
    ...
    void deleteDebt_ownerCanDeleteAnyDebt() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
        dto.setName("Admin");
        Group group = groupService.createGroup(dto);
    ...
    void validation_rejectsBlankAndInvalidValues() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
    ...
    void deleteGroup_removesDebtsAndMembers() {
        loginAs(owner);
        GroupDTO dto = new GroupDTO();
